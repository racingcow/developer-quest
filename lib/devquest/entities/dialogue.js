ig.module(
    ...
    .defines(function () {
         ...
         */
        devquest.entities.EntityDialogue = ig.EntityDialogue = ig.global.EntityDialogue = ig.EntityTrigger.extend(/**@lends ig.EntityConversation.prototype */{
