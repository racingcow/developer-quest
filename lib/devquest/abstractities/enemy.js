    ...
    .defines(function () {
        ...
        devquest.abstractities.Enemy = ig.Enemy = ig.global.Enemy = ig.Character.extend({
            ...
            update: function() {
                ...
                if (false) { //TODO: replace "false" with "not seeking and player within seeking range"
                    this.movingTo = true;
                    this._moveToPosAt = this._player.pos;
                }

                //if (this.movingTo) return; //we are already going somewhere, so keep going
                ...
                if (!this.movingTo ||
                    ...
                    this._moveToPosAt = this.patrolPts[this._patrolIdx];
            ...
            rangeToTarget: function(target) {
                ...
                var dx = target.x - this.pos.x,
                    ...
                    xCanAtk = _utm.almostEqual(dx, 0, 1), //33
                    yCanAtk = _utm.almostEqual(dy, 0, 1); //33
            ...
            moveToUpdate: function () {
                ...
                if (this.movingTo === true) {
                    ...
                    var range = this.rangeToTarget(this._moveToPosAt);
