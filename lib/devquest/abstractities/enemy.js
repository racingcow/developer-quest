...
ig.module(
	...
	.defines(function () {
		...
		devquest.abstractities.Enemy = ig.Creature.extend({
			...
			//controllable: false, //uncomment this line to make enemies sit around like lumps
			...
			initProperties: function() {
				...
				this.melee.damage = 10;
				this.melee.rangeX = _c.CHARACTER.SIZE_EFFECTIVE_X * 0.5;
				this.melee.rangeY = _c.CHARACTER.SIZE_EFFECTIVE_Y * 0.5;
			...
			attack: function( entity ) {
				return this.melee.activate();
			},

			resetExtras: function () {

				//spawners will not reset fleeing/predator stuff when enemy is grabbed from entity pool
				//todo: commit this
				this.fleeing = false;
				this.fleeingLowHealth = false;
				this.predator = null;
