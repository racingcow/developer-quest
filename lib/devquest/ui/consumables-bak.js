...
ig.module(
	...
	.defines(function () {
		...
		devquest.ui.ConsumablesBak = ig.global.ConsumablesBak = devquest.ui.UIMenuScreen.extend({
			...
			highlightMove: function(axis, offset) {
				...
				var rpp = _cfg.ROWS_PER_PAGE,
					rowCol = axis === 'x' ? 'COLS' : 'ROWS',
				...
				var curPageIdx = Math.floor(highlight.pos.inv.y / rpp),
					srcPageIdx = Math.floor(this.highlightSrc.pos.inv.y / rpp);
				this.highlightSrc.entity.visible = (srcPageIdx === curPageIdx);
				this.highlightSrc.entity.refresh(true);
				console.log('source highlight is visible? - ' + this.highlightSrc.entity.visible);
