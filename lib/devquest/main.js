	...
	function start() {
		ig.MainGame = ig.GameExtended.extend({
			...
			initFonts: function() {
				...
				ig.CONFIG.FONT.MENU_PATH = ig.CONFIG.PATH_TO_MEDIA + ig.CONFIG.FONT.MENU_NAME;
				ig.Font.FONTS.MENU = new ig.Font(_c.FONT.MENU_PATH);

				ig.CONFIG.FONT.MENU_SMALL_PATH = ig.CONFIG.PATH_TO_MEDIA + ig.CONFIG.FONT.MENU_SMALL_NAME;
				ig.Font.FONTS.MENU_SMALL = new ig.Font(_c.FONT.MENU_SMALL_PATH);
