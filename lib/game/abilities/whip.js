    ...
    .defines(function () {
        ...
        ig.AbilityWhip = ig.Ability.extend({
            ...
            activate: function (settings) {                
                ...
                var offsetPct = facing.vect;
                this.whip.currentAnim = this.whip.anims[facing.name];
                
                //impact++ will ignore settings if already moving, so set here manually
                if (this.whip.movingToSettings) {
                    this.whip.movingToSettings.offsetPct = offsetPct;
                }
