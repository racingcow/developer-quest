ig.module(
    ...
    .defines(function () {
        ...
        /**
         * Text bubble choice configuration settings.
         * <span class="alert alert-error"><strong>IMPORTANT:</strong> Don't modify config directly! (see example)</span>
         * @example
         * // in order to add your own custom configuration to Impact++
         * // edit the file defining ig.CONFIG_USER, 'plusplus.config-user'
         ...
         * @readonly
         * @memberof ig.CONFIG
         * @namespace ig.CONFIG.TEXT_BUBBLE_CHOICE
         * @author racingcow
         **/
        ig.CONFIG.TEXT_BUBBLE_CHOICE = {};

        /**
         * Horizontal size.
         * @type Number
         * @default
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.SIZE_X = 150;
         ...
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.SIZE_Y = 100;

        /**
         * Padding on the inside of text bubble choice to keep text spaced away from sides.
         * @type Number
         * @default
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.PADDING_X = 6;
         ...
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.PADDING_Y = 15;
         ...
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.CHOICE_SIZE_X = 100;
         ...
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.CHOICE_SIZE_Y = 30;

        /**
         * Padding between choices
         * @type Number
         * @default
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.CHOICE_PADDING_Y = 2;
         ...
         * @memberof ig.CONFIG.TEXT_BUBBLE_CHOICE
         */
        ig.CONFIG.TEXT_BUBBLE_CHOICE.CHOICE_TOP_PADDING_Y = 4;
